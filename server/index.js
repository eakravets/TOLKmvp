...
cleanliness — чистота речи: меньше слов-паразитов, повторов, сбивок и речевого мусора.
vocabulary — разнообразие, точность и естественность формулировок.
confidence — уверенность, плавность и связность речи.
meaning — насколько смысл пересказа соответствует исходному тексту.
...
- Средний результат обычно должен быть в диапазоне 45–80.
- Оценки выше 85 ставь только за действительно сильную речь.

Комментарий:
Напиши одно короткое предложение на русском до 18 слов.
